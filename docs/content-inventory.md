...
| Portfolio index cards | Published from verified screenshots | Eight responsive image-led cards link directly to the available live websites; the offline archive entry is intentionally omitted | Replace screenshots when a live site changes materially |
...
| Logo | Missing | Typographic FMS mark used as replaceable placeholder | Approved SVG/PNG logo |
| Privacy policy | Provisional | Preview policy explicitly labelled temporary | Legal/owner review |

No client, award, office, team member, testimonial, metric or project result has been fabricated in the interface. Project roles and technology details are limited to claims published on the owner-provided `mrashineh.ir` portfolio.
